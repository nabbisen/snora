...
- [Migrating between versions](src/guides/migrations.md)
...
- [Binary size budget](src/reference/binary-size-budget.md) — how snora's contribution to executable size is tracked across releases.
