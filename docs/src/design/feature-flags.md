...
snora = { version = "0.48", default-features = false, features = ["design"] }

# Widgets + design tokens
snora = { version = "0.48", features = ["widgets", "design"] }

# Widgets + design + Lucide icons
snora = { version = "0.48", features = ["widgets", "design", "lucide-icons"] }
```
