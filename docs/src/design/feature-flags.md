...
snora = { version = "0.47", default-features = false, features = ["design"] }

# Widgets + design tokens
snora = { version = "0.47", features = ["widgets", "design"] }

# Widgets + design + Lucide icons
snora = { version = "0.47", features = ["widgets", "design", "lucide-icons"] }
```
