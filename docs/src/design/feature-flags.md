...
snora = { version = "0.49", default-features = false, features = ["design"] }

# Widgets + design tokens
snora = { version = "0.49", features = ["widgets", "design"] }

# Widgets + design + Lucide icons
snora = { version = "0.49", features = ["widgets", "design", "lucide-icons"] }
```
