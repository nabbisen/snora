...
[CHANGELOG](https://github.com/nabbisen/snora/blob/main/CHANGELOG.md)
records what changed in each release, and
[ROADMAP](https://github.com/nabbisen/snora/blob/main/ROADMAP.md)
