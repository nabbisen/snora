...
```toml
snora = { version = "0.21", features = ["svg-icons"] }
```
...
snora = { version = "0.21", features = ["widgets", "lucide-icons"] }

# Widgets + SVG icon support:
snora = { version = "0.21", features = ["widgets", "svg-icons"] }

# Widgets + both icon sources:
snora = { version = "0.21", features = ["widgets", "lucide-icons", "svg-icons"] }
```
