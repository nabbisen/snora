...
```toml
snora = { version = "0.42", features = ["svg-icons"] }
```
...
snora = { version = "0.42", features = ["widgets", "lucide-icons"] }

# Widgets + SVG icon support:
snora = { version = "0.42", features = ["widgets", "svg-icons"] }

# Widgets + both icon sources:
snora = { version = "0.42", features = ["widgets", "lucide-icons", "svg-icons"] }
```
