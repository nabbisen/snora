...
```toml
snora = { version = "0.18", features = ["svg-icons"] }
```
...
snora = { version = "0.18", features = ["widgets", "lucide-icons"] }

# Widgets + SVG icon support:
snora = { version = "0.18", features = ["widgets", "svg-icons"] }

# Widgets + both icon sources:
snora = { version = "0.18", features = ["widgets", "lucide-icons", "svg-icons"] }
```
