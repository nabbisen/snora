...
- [Readability](guides/readability.md)
...
- [Migrating between versions](guides/migrations.md)
  ...
  - [0.35 → 0.36](guides/migration-0.35-to-0.36.md)
  ...
  - [0.42 → 0.43](guides/migration-0.42-to-0.43.md)
  - [0.43 → 0.44](guides/migration-0.43-to-0.44.md)
  - [0.44 → 0.45](guides/migration-0.44-to-0.45.md)
  - [0.45 → 0.46](guides/migration-0.45-to-0.46.md)
  - [0.46 → 0.47](guides/migration-0.46-to-0.47.md)
  - [0.47 → 0.48](guides/migration-0.47-to-0.48.md)
...
- [Recipes](design/recipes/index.md)
